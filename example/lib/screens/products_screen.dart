...
import 'package:bloc_manager_example/widgets/product_card_skeleton.dart';
...
class ProductsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          // Status bar with auto-refresh info (outside BlocManager so skeleton
          // only replaces the grid area, not the status bar)
          BlocBuilder<ProductsCubit, BaseState<List<dynamic>>>(
            builder: (context, state) {
              return Container(
          ...
          Expanded(
            child: BlocManager<ProductsCubit, BaseState<List<dynamic>>>(
              bloc: cubit,
