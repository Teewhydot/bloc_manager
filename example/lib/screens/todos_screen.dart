...
import 'package:bloc_manager_example/widgets/todo_card_skeleton.dart';
...
/// - **LoadingState**: Shows while fetching data — skeleton placeholders replace the spinner
...
class TodosScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          // State indicator banner (outside BlocManager — always visible)
          ...
          // Content
          Expanded(
            child: BlocManager<TodosCubit, BaseState<List<dynamic>>>(
              bloc: cubit,
              showLoadingIndicator: false,
              showResultSuccessNotifications: true,
              child: const SizedBox.shrink(),
              builder: (context, state) {
                // InitialState — welcome screen with load prompt
                                ...
                                trailing: Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      color: Colors.green,
                                      tooltip:
                                          'Mark complete (shows SuccessState)',
                                      onPressed: () =>
                                          cubit.toggleTodo(todo.id ?? 0),
                                    ),
                                    IconButton(
